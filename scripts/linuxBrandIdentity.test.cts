...
assert.match(builderSource, /productName: "年糕"/);
...
assert.match(createShortcutSource, /SHORTCUT_NAME="StickyCake\.desktop"/);
assert.match(createShortcutSource, /Exec=\/opt\/StickyCake\/年糕 %U/);
assert.match(removeShortcutSource, /SHORTCUT_NAME="StickyCake\.desktop"/);
